...
local v722 = new_class():struct("references")({
    ...
    init = function(v24)
        ...
        v24.groups = {
            fakemain = l_pui_0.create("\v\239\138\189", " ", 1), 
        ...
        v24.elements = {
            idklol1 = v24.groups.fakemain:label("Fixed by zadyma."),
            idklol2 = v24.groups.fakemain:label("fuck trapsody $$"), 
            ...
            about = v24.groups.main:list("", "\v\239\128\135       \rzadyma.", "\v\239\130\133     \rOther"), 
            ...
            configs = v24.groups.products:label("\v\226\128\162    \a{Small Text}My links"), 
            config_button = v24.groups.products:button("\a{Active Text}LUA Github", function()
                panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://github.com/aspyr1g/neverpaste-luas");
            end, true), 
            config_button_beta = v24.groups.products:button("\a{Active Text}Youtube  \a{Small Text}\239\129\173", function()
                panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://www.youtube.com/@zadymaduh");
            end, true), 
    ...
    setup = function(v672)
        v672.script_name = "Nyanza Snapshot";
...
common.add_notify("fixed by zadyma.", "last lua update: 23.07.2025")
common.add_notify("fixed by zadyma.", "last lua update: 23.07.2025")
common.add_notify("fixed by zadyma.", "last lua update: 23.07.2025")