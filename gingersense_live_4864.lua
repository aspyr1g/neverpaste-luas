...
r0_0.defensive = {
  ...
  time_to_ticks = function(r0_8)
    -- line: [0, 0] id: 8
    return math.floor(r0_8 / globals.tickinterval + 0.5)
  end,
  net_data = {},
  sim_ticks = {},
}
local r1_0 = {
  active = function(r0_7)
    -- line: [0, 0] id: 7
    r0_0.animation = r0_7
  end,
  overlay = function(r0_6, r1_6)
    -- line: [0, 0] id: 6
    if not r1_6 then
      r1_6 = 12
    end
    if entity.get_local_player() == nil or ffi.cast("uintptr_t**", r0_6) == nil then
      return 
    end
    return ffi.cast("animation_layer_t_12389890123890321890089123**", ffi.cast("char*", r0_6) + 10640)[0][r1_6]
  end,
  state = function(r0_5)
    -- line: [0, 0] id: 5
    if entity.get_local_player() == nil or ffi.cast("uintptr_t**", r0_5) == nil then
      return 
    end
    return ffi.cast("CCSGOPlayerAnimationState_534535_t**", ffi.cast("char*", r0_5) + 39264)[0]
  end,
}
local r2_0 = {
  ways = function(r0_4, r1_4)
    -- line: [0, 0] id: 4
    if r0_0.numbers.ways[r0_4] == nil then
      r0_0.numbers.ways[r0_4] = {
        init = 1,
      }
    end
    if globals.choked_commands == 0 then
      r0_0.numbers.ways[r0_4].init = r0_0.numbers.ways[r0_4].init + 1
    end
    if #r0_4 < r0_0.numbers.ways[r0_4].init then
      r0_0.numbers.ways[r0_4].init = 1
    end
    return r1_4[r0_0.numbers.ways[r0_4].init]
  end,
}
local r3_0 = {
  defensive = {
    update = function()
      -- line: [0, 0] id: 3
      local r0_3 = entity.get_entities(false, true)
      for r4_3 = 1, #r0_3, 1 do
        local r5_3 = r0_3[r4_3]
        local r6_3 = r5_3:get_index()
        local r7_3 = r0_0.defensive.sim_ticks[r6_3]
        if r5_3:is_dormant() or not r5_3:is_alive() then
          r0_0.defensive.sim_ticks[r6_3] = nil
        else
          local r8_3 = r0_0.defensive.time_to_ticks(r5_3:get_simulation_time().current)
          if r7_3 ~= nil then
            local r9_3 = r8_3 - r7_3
            if r9_3 < 0 or 0 < r9_3 and r9_3 <= 64 then
              r0_0.defensive.net_data[r6_3] = r9_3 - 1
            end
          end
          r0_0.defensive.sim_ticks[r6_3] = r8_3
        end
      end
    end,
    get = function()
      ...
      if ui.find("Aimbot", "Ragebot", "Main", "Double Tap"):get() or ui.find("Aimbot", "Ragebot", "Main", "Hide Shots"):get() then
        local r0_2 = entity.get_local_player()
        if r0_2 == nil or not r0_2:is_alive() then
          return 
        end
        for r4_2, r5_2 in pairs(r0_0.defensive.net_data) do
          r4_2 = entity.get(r4_2)
          if r4_2 == r0_2 then
            r0_0.defensive.defensive = 0 <= r5_2
          end
        end
        r0_0.defensive.is_break_defensive = r0_0.defensive.defensive
        if ui.find("Aimbot", "Ragebot", "Main", "Double Tap", "Lag Options"):get() == "Always On" or ui.find("Aimbot", "Ragebot", "Main", "Hide Shots", "Options"):get() == "Favor Fire Rate" then
          local r2_2 = r0_0.defensive.is_break_defensive
          r0_0.defensive.is_break_defensive = not r0_2
        end
      else
        r0_0.defensive.is_break_defensive = true
      end
      return r0_0.defensive.is_break_defensive
    end,
  },
}
events.createmove:set(function(r0_1)
  -- line: [0, 0] id: 1
  r0_1.animate_move_lean = r0_0.animation
end)
return {
  animation = r1_0,
  numbers = r2_0,
...
local v618 = new_class():struct("globals")({
    ...
    execute = function(v10)
        ...
        v10.menu.global.promo = v12.user_info:label("Fixed by zadyma.");
