...
download1337 = v15.main.group:label("Download Files");
v15.main.download_button = download1337:create():button("13", nil, true):tooltip("\226\139\133 Manually start the download of all preset sounds." .. "\n\n" .. v10.yellow .. v14["circle-exclamation-check"] .. "  If its not working, enable a VPN.");
v15.mode = {
...
v15.custom_builder.weapon_selector = v15.custom_builder.group:list("", v9);
...
local function v65(v66)
    -- upvalues: v4 (ref), v5 (ref), l_manager_0 (ref), v10 (ref), v14 (ref), v65 (ref)
    if not v66 then
        v66 = 1;
    end;
    v4 = v66;
    ...
    if v66 == 100 then
        if not l_manager_0.exists(v5 .. "cs2/ak47.wav") and not l_manager_0.exists(v5 .. "legacy/ak47.wav") and not l_manager_0.exists(v5 .. "css/ak47.wav") then
...
v15.main.download_button:set_callback(function()
    panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://github.com/aspyr1g/customweaponsounds/raw/refs/heads/main/temp.zip");
end);
v15.main.master_switch:set_callback(function(v93)
    -- upvalues: v4 (ref), l_manager_0 (ref), v5 (ref), v65 (ref)
    if v93:get() and v4 == 0 and not files.exists(v5 .. "cs2/ak47.wav") and not files.exists(v5 .. "legacy/ak47.wav") and not files.exists(v5 .. "css/ak47.wav") then
        v65();
    end;
end, true);
