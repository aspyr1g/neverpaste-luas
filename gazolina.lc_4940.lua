...
-- REFACTORED: Removed goto by restructuring the logic
local function r8_0(r0_19, r1_19)
  -- line: [0, 0] id: 19
  local r2_19 = type(r0_19)
  if r2_19 == "number" then
    if 1 <= r0_19 and r0_19 <= r1_19 then
...
-- REFACTORED: Removed goto by extracting common code into a helper function
local function putTableToString(r0_4, r1_4)
  -- Helper function that handles the tostring case (formerly label_8)
  r0_4:puts(r1_0(r1_4))
end
...
function r17_0.putTable(r0_4, r1_4)
  ...
  -- Check if it's KEY or METATABLE - both use the same tostring handling
  if r1_4 == r2_4 or r1_4 == r0_0.METATABLE then
    putTableToString(r0_4, r1_4)
  elseif r0_4:alreadyVisited(r1_4) then
    r5_4 = r0_4:getId(r1_4)
...
local r0_0 = nil
r0_0 = {
  follow_relative_jump = function(r0_11)
    -- line: [0, 0] id: 11
    return ffi.cast("int*", r0_11 + 1)[0] + r0_11 + 5
  end,
  get_ctype = function(r0_10, ...)
    -- line: [0, 0] id: 10
    assert(r0_10 ~= nil, "target address is null")
    local r1_10, r2_10 = pcall(ffi.typeof, ...)
    if not r1_10 then
      r1_10, r2_10 = pcall(ffi.typeof, r0_10)
    end
    assert(r1_10, string.format("invalid C type (%s)", r2_10))
    r1_10, r0_10 = pcall(ffi.cast, r2_10, r0_10)
    assert(r1_10, string.format("invalid C type (%s)", r0_10))
    return r0_10, r2_10
  end,
  make_pointer = function(r0_9)
    -- line: [0, 0] id: 9
    local r1_9, r2_9 = pcall(ffi.typeof, "$[1]", r0_9)
    assert(r1_9, string.format("invalid C type (%s)", r2_9))
    return r2_9()
  end,
}
local r1_0 = nil
local r3_0 = ffi.typeof("bool(__cdecl*)(void*, void*, void*, bool)")
local r4_0 = ffi.typeof("void(__cdecl*)(void*, bool)")
local r5_0 = ffi.cast
local r6_0 = "uintptr_t"
local r7_0 = utils.opcode_scan("gameoverlayrenderer.dll", "55 8B EC 51 8B 45 10 C7")
if not r7_0 then
  r7_0 = error("invalid signature #1", 2)
end
r5_0 = r5_0(r6_0, r7_0)
r6_0 = r0_0.follow_relative_jump
r7_0 = ffi.cast
local r8_0 = "uintptr_t"
local r9_0 = utils.opcode_scan("gameoverlayrenderer.dll", "E8 ? ? ? ? 83 C4 08 FF 15 ? ? ? ?")
if not r9_0 then
  r9_0 = error("invalid signature #2", 2)
end
r6_0 = r6_0(r7_0(r8_0, r9_0))
r1_0 = ffi.cast(r3_0, r5_0)
local r2_0 = ffi.cast(r4_0, r6_0)

-- REFACTORED: Removed goto from hook_func
function r0_0.hook_func(r0_2, r1_2, ...)
  -- line: [0, 0] id: 2
  local r2_2 = assert
  local r3_2 = nil
  
  -- Restructured: combined the nil check and type check
  if r1_2 ~= nil and type(r1_2) == "function" then
    r3_2 = true
  else
    r3_2 = false
  end
  
  r2_2(r3_2, "invalid target function")
  r2_2 = nil
  local r3_2, r4_2 = r0_0.get_ctype(r0_2, ...)
  local r5_2 = r0_0.make_pointer(r4_2)
  local r6_2, r7_2 = pcall(ffi.cast, r4_2, function(...)
    -- line: [0, 0] id: 8
    local r0_8 = {
      pcall(r1_2, r2_2, ...)
    }
    if r0_8[1] == true then
      return select(2, unpack(r0_8))
    end
    return r5_2[0](...)
  end)
  assert(r6_2, string.format("invalid C type (%s)", r7_2))
  local r8_2 = nil
  local r9_2 = {}
  local r10_2 = {}
  local function r11_2()
    -- line: [0, 0] id: 7
    return r2_0(r3_2, false)
  end
  function r10_2.get_original(r0_6, ...)
    -- line: [0, 0] id: 6
    return r5_2[0](...)
  end
  
  -- REFACTORED: Removed goto from get_address
  function r10_2.get_address(r0_5, r1_5)
    -- line: [0, 0] id: 5
    local r2_5 = nil
    if r1_5 == true and r7_2 then
      r2_5 = r7_2
    else
      r2_5 = r3_2
    end
  ...
  function r10_2.detach(r0_4)
    -- line: [0, 0] id: 4
    r11_2()
    events.shutdown:unset(r11_2)
    return r0_4
  end
  function r10_2.attach(r0_3)
    -- line: [0, 0] id: 3
    if not r1_0(r3_2, r7_2, r5_2, false) and last_log == nil then
      return error("an unknown error occured", 2)
    end
    events.shutdown:set(r11_2)
    return r0_3
  end
  r2_2 = setmetatable(r9_2, {
    __metatable = false,
    __index = r10_2,
  })
  -- close: 9 -- jump: 32768
...
function r0_0.hook_vfunc(r0_1, r1_1, r2_1, r3_1, ...)
  -- line: [0, 0] id: 1
  local r4_1 = ffi.cast
  local r5_1 = "void***"
  local r6_1 = utils.create_interface(r0_1, r1_1)
  if not r6_1 then
    r6_1 = error("invalid interface", 2)
  end
  return r0_0.hook_func(r4_1(r5_1, r6_1)[0][r2_1], r3_1, ...)
end
-- close: 1 -- jump: 32768
return r0_0
