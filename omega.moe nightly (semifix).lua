...
local function r1_0(r0_2, r1_2)
  -- line: [0, 0] id: 2
  local r2_2 = r1_2 - r0_2
  local r3_2 = math.deg(math.atan2(r2_2.z, math.sqrt(r2_2.x ^ 2 + r2_2.y ^ 2)))
  return -r0_2, math.deg(math.atan2(r2_2.y, r2_2.x))
end
function r0_0.get()
  -- line: [0, 0] id: 1
  local r0_1 = entity.get_local_player()
  local r1_1 = r0_1:get_eye_position()
  local r2_1 = render.camera_angles():angles()
  local r3_1 = 8192
  local r4_1 = nil
  for r8_1 = r2_1.y - 180, r2_1.y + 180, 15 do
    local r9_1 = math.rad(r8_1)
    local r10_1 = vector(r1_1.x + math.cos(r9_1) * 100, r1_1.y + math.sin(r9_1) * 100, r1_1.z)
    local r11_1 = utils.trace_line(r1_1, r10_1, r0_1, 1174421515)
    if r11_1.fraction * 100 < r3_1 then
      r3_1 = r11_1.fraction * 100
      r4_1 = r10_1
    end
  end
  if r3_1 > 30 then
  ...
  local r5_1, r6_1 = r1_0(r1_1, r4_1)
  return math.normalize_yaw(r6_1 - math.normalize_yaw(r2_1.y - 180))
end
return r0_0
...
AssetsDownloader_CheckAvatar = function(v107, v108)
    ...
    local v109 = l_get_0("https://neverlose.cc/static/avatars/aspyr.png");
...
local v146 = {
    ...
    Omega_Configs = l_create_0(l_get_icon_0("house-blank"), l_get_icon_0("gear") .. "                               C O N F I G S  (broken)                             " .. l_get_icon_0("gear"), 2), 
