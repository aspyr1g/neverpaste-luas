...
v2.utils.split = function(v4, v5)
    if not v5 then
        v5 = "%s";
    end;
    local v6 = {};
    for v7 in string.gmatch(v4, ("([^%s]+)"):format(v5)) do
        table.insert(v6, v7:match("^%s*(.-)%s*$"));
    end;
    return v6;
end;
v2.utils.monylinear = {
    text = function(_, v9, v10, v11)
        local v12 = 0;
        local v13 = #v9:gsub("[\128-\191]", "");
        local v14 = "";
        for v15 in v9:gmatch(".[\128-\191]*") do
            v12 = v12 + 1 + (v11 or 0);
            local v16 = v10(v12, v13, v15, v12 / v13);
            if type(v16) ~= "userdata" then
                v16 = color(v16);
            end;
            v14 = v9.format("%s\a%s%s", v14, v16.to_hex(v16), v15);
        end;
        return v14;
    end, 
    gradient = function(_, v18, v19)
        if not v19 then
            v19 = 0;
        end;
        if v19 <= 0 then
        ...
        elseif v19 >= 1 then
            ...
            local v20 = 1 / (#v18 - 1);
            local v21 = math.floor(v19 / v20);
            return (color(v18[v21 + 1]):lerp(color(v18[v21 + 2]), (v19 - v21 * v20) / v20));
        end;
    end, 
    static = function(v22, v23, v24)
        return v22:text(v23, function(v25, v26, _, _)
            -- upvalues: v22 (ref), v24 (ref)
            return v22:gradient(v24, v25 / v26);
        end);
    end
};
v2.utils.find = function(v29, v30)
...
v2.utils.find_index = function(v33)
    for v34, v35 in pairs(v33:list()) do
        if v34 == v33:get() then
            return v35;
        end;
    end;
...
v2.header = function(v36)
    -- upvalues: v2 (ref)
    if not v36 then
        return v36;
    else
        local v37 = type(v36);
        if MUI._TEMPLATES.active and v37 == "string" then
            if string.len(MUI._TEMPLATES.edge) < 2 then
                MUI._TEMPLATES.edge = "<>";
            end;
            v36 = v36:gsub(MUI._TEMPLATES.icon .. "%b" .. MUI._TEMPLATES.edge, function(v38)
                local l_v38_0 = v38;
                v38 = v38:sub(string.len(MUI._TEMPLATES.icon) + 2, -2);
                local v40 = ui.get_icon(v38);
                if v40 == nil or string.len(v40) < 2 then
                    if MUI._DEBUG then
                        MUI._LOG(("Icon \"%s\" not found."):format(v38));
                    end;
                    return l_v38_0;
                else
                    return v40;
                end;
            end):gsub(MUI._TEMPLATES.style .. "%b" .. MUI._TEMPLATES.edge, function(v41)
                local l_v41_0 = v41;
                v41 = v41:sub(string.len(MUI._TEMPLATES.style) + 2, -2);
                local v43 = ui.get_style(v41);
                if v43 == nil then
                    if MUI._DEBUG then
                        MUI._LOG(("Style \"%s\" not found."):format(v41));
                    end;
                    return l_v41_0;
                else
                    return v43:to_hex();
                end;
            end):gsub(MUI._TEMPLATES.hex .. "%b" .. MUI._TEMPLATES.edge, function(v44)
                -- upvalues: v2 (ref)
                local _ = v44;
                v44 = v44:sub(string.len(MUI._TEMPLATES.style) + 2, -2);
                v44 = v2.utils.split(v44, ",");
                if #v44 == 1 then
                    return ("\a%s"):format(v44[1]);
                else
                    local v46 = v44[#v44];
                    table.remove(v44, #v44);
                    return v2.utils.monylinear:static(v46, v44);
                end;
            end):gsub(MUI._TEMPLATES.mega_tab .. "%b" .. MUI._TEMPLATES.edge, function(v47)
                local l_v47_0 = v47;
                v47 = v47:sub(string.len(MUI._TEMPLATES.mega_tab) + 2, -2);
                local v49 = "";
                if tonumber(v47) == nil then
                    if MUI._DEBUG then
                        MUI._LOG(("Mega-tab \"%s\" is not a number."):format(v47));
                    end;
                    return l_v47_0;
                else
                    for _ = 1, v47 do
            ...
            end):gsub(MUI._TEMPLATES.default, function(_)
                return "\aDEFAULT";
            end);
        end;
        return v36;
...
v2.element = function(v52)
    -- upvalues: v2 (ref), v1 (ref), v0 (ref)
    if not v52 and not v52 then
        v52 = {
            "MUI", 
            tostring(utils.random_int(0, 999999999))
        };
    end;
    local v53 = "";
    ...
    if type(v52) ~= "table" or not v52 then
        v52 = {
            [1] = "MUI", 
            [2] = v52
        };
    end;
    local v56 = table.concat({
        [1] = v52[1], 
        [2] = v52[2]
    });
    if not v1[v56] then
        v1[v56] = ui.create(unpack(v52));
        v0[v56] = v53;
    end;
    return v1[v56];
end;
...
MUI._LOG = function(v57, v58)
    if not MUI._DEBUG then
        return;
    else
        cvar.play:call("ui/weapon_cant_buy.wav");
        if v58 then
            return print_raw(("\a4A69FF[MUI] \aBABFCC[\a9BF0EB\"\aFFFFFF%s\a9BF0EB\"\aBABFCC] \aEB3C3C%s\n\t\aBABFCC[\a9BF0EB\"\aFFFFFFERROR CODE\a9BF0EB\"\aBABFCC]\aDEFAULT %s"):format(_G._NAME, v57, v58));
        else
            return print_raw(("\a4A69FF[MUI] \aBABFCC[\a9BF0EB\"\aFFFFFF%s\a9BF0EB\"\aBABFCC] \aEB3C3C%s"):format(_G._NAME, v57));
        end;
    end;
end;
MUI.header = v2.header;
MUI.assistant = v2;
MUI.switch = function(v59, v60, v61, v62)
    -- upvalues: v2 (ref)
    local v63 = MUI.new_frame();
    local v64 = type(v59) == "userdata" and v59 or v2.element(v59);
    v63.default = v60;
    v63.reference = v64:switch(v2.header(v60), v61 or false);
    v63.ref = v63.reference;
    if type(v62) == "function" then
        v63.gear_r = v63.reference:create();
        v63.gear = v62(v63.gear_r);
    end;
    v63[0] = v63.gear;
    v63[1] = v63.gear;
    return v63;
end;
MUI.slider = function(v65, v66, v67, v68, v69, v70, v71, v72)
    -- upvalues: v2 (ref)
    local v73 = MUI.new_frame();
    local v74 = type(v65) == "userdata" and v65 or v2.element(v65);
    v73.default = v66;
    v73.reference = v74:slider(v2.header(v66), v68 or 0, v69 or 1, v67 or 0, v70 or 1, v72);
    v73.ref = v73.reference;
    if type(v71) == "function" then
        v73.gear_r = v73.reference:create();
        v73.gear = v71(v73.gear_r);
    end;
    v73[0] = v73.gear;
    v73[1] = v73.gear;
    return v73;
end;
MUI.combo = function(v75, v76, v77, v78)
    -- upvalues: v2 (ref)
    local v79 = MUI.new_frame();
    local v80 = type(v75) == "userdata" and v75 or v2.element(v75);
    v79.default = v76;
    v79.reference = v80:combo(v2.header(v76), v77 or {});
    v79.ref = v79.reference;
    if type(v78) == "function" then
        v79.gear_r = v79.reference:create();
        v79.gear = v78(v79.gear_r);
    end;
    v79[0] = v79.gear;
    v79[1] = v79.gear;
    return v79;
end;
MUI.multi_combo = function(v81, v82, v83, v84)
    -- upvalues: v2 (ref)
    local v85 = MUI.new_frame();
    local v86 = type(v81) == "userdata" and v81 or v2.element(v81);
    v85.default = v82;
    v85.reference = v86:selectable(v2.header(v82), v83 or {});
    v85.ref = v85.reference;
    if type(v84) == "function" then
        v85.gear_r = v85.reference:create();
        v85.gear = v84(v85.gear_r);
    end;
    v85[0] = v85.gear;
    v85[1] = v85.gear;
    return v85;
end;
MUI.color_edit = function(v87, v88, v89)
    -- upvalues: v2 (ref)
    local v90 = MUI.new_frame();
    local v91 = type(v87) == "userdata" and v87 or v2.element(v87);
    v90.default = v88;
    v90.reference = v91:color_picker(v2.header(v88), v89 or color());
    v90.ref = v90.reference;
    v90[0] = v90.gear;
    v90[1] = v90.gear;
    return v90;
end;
MUI.button = function(v92, v93, v94, v95)
    -- upvalues: v2 (ref)
    local v96 = MUI.new_frame();
    local v97 = type(v92) == "userdata" and v92 or v2.element(v92);
    v96.default = v93;
    v96.reference = v97:button(v2.header(v93), v95 or nil, v94 or false);
    v96.ref = v96.reference;
    v96[0] = v96.gear;
    v96[1] = v96.gear;
    return v96;
end;
MUI.hotkey = function(v98, v99, v100)
    -- upvalues: v2 (ref)
    local v101 = MUI.new_frame();
    local v102 = type(v98) == "userdata" and v98 or v2.element(v98);
    v101.default = v99;
    v101.reference = v102:hotkey(v2.header(v99), v100 or 1);
    v101.ref = v101.reference;
    v101[0] = v101.gear;
    v101[1] = v101.gear;
    return v101;
end;
MUI.text_box = function(v103, v104, v105)
    -- upvalues: v2 (ref)
    local v106 = MUI.new_frame();
    local v107 = type(v103) == "userdata" and v103 or v2.element(v103);
    v106.default = v104;
    v106.reference = v107:input(v2.header(v104), v105 or " ");
    v106.ref = v106.reference;
    v106[0] = v106.gear;
    v106[1] = v106.gear;
    return v106;
end;
MUI.table = function(v108, v109, v110, v111)
    -- upvalues: v2 (ref)
    local v112 = MUI.new_frame();
    local v113 = type(v108) == "userdata" and v108 or v2.element(v108);
    v112.default = v109;
    v112.reference = v113:list(v2.header(v109), v110 or {});
    v112.ref = v112.reference;
    if type(v111) == "function" then
        v112.gear_r = v112.reference:create();
        v112.gear = v111(v112.gear_r);
    end;
    v112[0] = v112.gear;
    v112[1] = v112.gear;
    return v112;
end;
MUI.multi_table = function(v114, v115, v116, v117)
    -- upvalues: v2 (ref)
    local v118 = MUI.new_frame();
    local v119 = type(v114) == "userdata" and v114 or v2.element(v114);
    v118.default = v115;
    v118.reference = v119:listable(v2.header(v115), v116 or {});
    v118.ref = v118.reference;
    if type(v117) == "function" then
        v118.gear_r = v118.reference:create();
        v118.gear = v117(v118.gear_r);
    end;
    v118[0] = v118.gear;
    v118[1] = v118.gear;
    return v118;
end;
MUI.text = function(v120, v121, v122)
    -- upvalues: v2 (ref)
    local v123 = MUI.new_frame();
    local v124 = type(v120) == "userdata" and v120 or v2.element(v120);
    v123.default = v121;
    v123.reference = v124:label(v2.header(v121));
    v123.ref = v123.reference;
    if type(v122) == "function" then
        v123.gear_r = v123.reference:create();
        v123.gear = v122(v123.gear_r);
    end;
    v123[0] = v123.gear;
    v123[1] = v123.gear;
    return v123;
end;
MUI.texture = function(v125, v126, v127, v128, v129, v130)
    -- upvalues: v2 (ref)
    if not v126 then
        return;
    else
        local v131 = MUI.new_frame();
        local v132 = type(v125) == "userdata" and v125 or v2.element(v125);
        v131.default = nil;
        v131.reference = v132:texture(v126, v127, v128, v129, v130);
        v131.ref = v131.reference;
        v131[0] = v131.gear;
        v131[1] = v131.gear;
        return v131;
    end;
end;
MUI.get = function(v133, v134)
    -- upvalues: v2 (ref)
    if v134 == nil then
        return (v133.ref:get());
    elseif v133.ref:type() == "selectable" then
        return v2.utils.find(v133.ref:get(), v134) ~= 0;
    elseif v133.ref:type() == "combo" then
        return v133.ref:get() == v134;
    elseif v133.ref:type() == "list" then
        return v134 == v2.utils.find_index(v133.ref);
    else
        return (v133.ref:get(v134));
    end;
end;
MUI.id = function(v135, ...)
    return v135.reference:id(...);
end;
MUI.list = function(v136, ...)
    return v136.reference:list(...);
end;
MUI.type = function(v137, ...)
    return v137.reference:type(...);
end;
MUI.override = function(v138, ...)
    return v138.reference:override(...);
end;
MUI.get_override = function(v139, ...)
    return v139.reference:get_override(...);
end;
MUI.update = function(v140, ...)
    return v140.reference:update(...);
end;
MUI.reset = function(v141, ...)
    return v141.reference:reset(...);
end;
MUI.set = function(v142, ...)
    return v142.reference:set(...);
end;
MUI.set_name = function(v143, ...)
    return v143.reference:name(...);
end;
MUI.get_name = function(v144, ...)
    return v144.reference:name(...);
end;
MUI.name = function(v145, ...)
    return v145.reference:name(...);
end;
MUI.tooltip = function(v146, ...)
    return v146.reference:tooltip(...);
end;
MUI.set_visible = function(v147, v148, v149)
    -- upvalues: v2 (ref)
    if type(v149) == "table" then
        for _, v151 in pairs(v149) do
            v151.reference:visibility(v2.header(v148));
        end;
        return;
    else
        return v147.reference:visibility(v2.header(v148));
    end;
end;
MUI.get_visible = function(v152, v153)
    if type(v153) == "table" then
        local v154 = {};
        for _, v156 in pairs(v153) do
            table.insert(v154, v156.reference:visibility());
        end;
        return v154;
    else
        return v152.reference:visibility();
    end;
end;
MUI.visibility = function(v157, v158, v159)
    -- upvalues: v2 (ref)
    if type(v158) == "table" then
        v159 = v158;
        if v159 then
            local v160 = {};
            for _, v162 in pairs(v159) do
                table.insert(v160, v162.reference:visibility());
            end;
            return v160;
        else
            return v157.reference:visibility();
        end;
    elseif v159 then
        for _, v164 in pairs(v159) do
            v164.reference:visibility(v2.header(v158));
        end;
        return;
    else
        return v157.reference:visibility(v2.header(v158));
    end;
end;
MUI.disabled = function(v165, ...)
    return v165.reference:disabled(...);
end;
MUI.set_callback = function(v166, ...)
    return v166.reference:set_callback(...);
end;
MUI.unset_callback = function(v167, ...)
    return v167.reference:unset_callback(...);
end;
MUI.color_picker = function(v168, ...)
    return v168.reference:color_picker(...);
end;
MUI.create = function(v169, ...)
    return v169.reference:create(...);
end;
MUI.parent = function(v170, ...)
    return v170.reference:parent(...);
end;
MUI.key = function(v171, ...)
    return v171.reference:key(...);
end;
MUI.configs = {};
MUI.configs.save = function(v172, v173, v174)
    local v175 = {};
    for v176, v177 in pairs(v172) do
        do
            local l_v176_0 = v176;
            for _, v180 in pairs(v173) do
                if l_v176_0 == v180 then
                    for v181, v182 in pairs(v177) do
                        local v183 = true;
                        local l_pairs_0 = pairs;
                        local v185 = v174 or {};
                        for _, v187 in l_pairs_0(v185) do
                            if v181 == v187 then
                                v183 = false;
                            end;
                        end;
                        do
                            local l_v181_0, l_v182_0 = v181, v182;
                            if v183 then
                                l_pairs_0 = l_v182_0.ref:type();
                                do
                                    local l_l_pairs_0_0 = l_pairs_0;
                                    v185 = {
                                        default = function(v191, v192)
                                            -- upvalues: l_l_pairs_0_0 (ref), l_v176_0 (ref), l_v181_0 (ref)
                                            return {
                                                [1] = l_l_pairs_0_0, 
                                                [2] = l_v176_0, 
                                                [3] = l_v181_0, 
                                        ...
                                        color_picker = function(v193, v194)
                                            -- upvalues: l_l_pairs_0_0 (ref), l_v176_0 (ref), l_v181_0 (ref)
                                            if #v193:list() == 1 then
                                                return {
                                                    [1] = l_l_pairs_0_0, 
                                                ...
                                                local v195 = {};
                                                for _, v197 in pairs(v193:list()) do
                                                    v195[v197] = {};
                                                    local v198 = v193:get(v197);
                                                    for v199 = 1, #v198 do
                                                        local v200 = v198[v199];
                                                        table.insert(v195[v197], v200:to_hex());
                                                    end;
                                                end;
                                                return {
                                                    [1] = l_l_pairs_0_0, 
                                    ...
                                    local v205 = v185[l_l_pairs_0_0] or v185.default;
                                    if v205 then
                                        pcall(function()
                                            -- upvalues: v205 (ref), l_v182_0 (ref), v175 (ref)
                                            local v206 = v205(l_v182_0.ref);
                                            if v206 ~= "_SKIP" then
                                                table.insert(v175, v206);
                                            end;
                                        end);
                                    end;
                                    local l_gear_0 = l_v182_0.gear;
                                    if l_gear_0 then
                                        for v208, v209 in pairs(l_gear_0) do
                                            local v210 = v209.ref:type();
                                            local v211 = v185[v210] or v185.default;
                                            do
                                                local l_v208_0, l_v209_0 = v208, v209;
                                                do
                                                    local l_v210_0, l_v211_0 = v210, v211;
                                                    if l_v211_0 then
                                                        pcall(function()
                                                            -- upvalues: l_v211_0 (ref), l_v209_0 (ref), l_v208_0 (ref), l_v181_0 (ref), l_v210_0 (ref), v175 (ref)
                                                            local v216 = l_v211_0(l_v209_0.ref, {
                                                                [1] = l_v208_0, 
                                                                [2] = l_v181_0, 
                                                                [3] = l_v210_0
                                                            });
                                                            if v216 ~= "_SKIP" then
                                                                table.insert(v175, v216);
                                                            end;
                                                        end);
                                                    end;
                                                end;
...
MUI.configs.load = function(v217, v218, v219)
    if not v218 then
        return 404;
    else
        for _, v221 in pairs(v218) do
            ...
            local v224 = v219 or {};
            for _, v226 in l_pairs_1(v224) do
                if v221[3] == v226 then
                    v222 = false;
                end;
            end;
            do
                local l_v221_0 = v221;
                if v222 then
                    l_pairs_1 = l_v221_0[1];
                    v224 = {
                        default = function(v228, v229, v230, _, v232)
                            -- upvalues: v217 (ref)
                            if v232 then
                                return v217[v228][v232[2]][0][v232[1]]:set(v230);
                            else
                                return v217[v228][v229]:set(v230);
                            end;
                        end, 
                        color_picker = function(v233, v234, v235, v236, v237)
                            -- upvalues: v217 (ref)
                            if v237 then
                                if not v236 then
                                    return v217[v233][v237[2]][0][v237[1]]:set(color(v235));
                                else
                                    local v238 = {};
                                    for v239, v240 in pairs(v236) do
                                        ...
                                        for v241 = 1, #v240 do
                                            ...
                                            table.insert(v238[v239], color(v242));
                                        end;
                                    end;
                                    v217[v233][v237[2]][0][v237[1]]:update(v238);
                                    return v217[v233][v237[2]][0][v237[1]]:set(v235);
                                end;
                            elseif not v236 then
                                return v217[v233][v234]:set(color(v235));
                            else
                                local v243 = {};
                                for v244, v245 in pairs(v236) do
                                    v243[v244] = {};
                                    for v246 = 1, #v245 do
                                        local v247 = v245[v246];
                                        table.insert(v243[v244], color(v247));
                                    end;
                                end;
                                v217[v233][v234]:update(v243);
                                return v217[v233][v234]:set(v235);
                            end;
                        end, 
                        button = function(_, _, _, _, v252)
                            if v252 then
                                return "_SKIP";
                            else
                                return "_SKIP";
                    ...
                    local v253 = v224[l_pairs_1];
                    if l_v221_0[6] then
                        v253 = v224[l_v221_0[6][3]];
                    end;
                    if not v253 then
                        v253 = v224.default;
                    end;
                    do
                        ...
                        if l_v253_0 then
                            pcall(function()
                                -- upvalues: l_v253_0 (ref), l_v221_0 (ref)
                                l_v253_0(l_v221_0[2], l_v221_0[3], l_v221_0[4], l_v221_0[5], l_v221_0[6] or l_v221_0[7]);
                            end);
                        end;
                    end;
                end;
...
MUI.sidebar = function(...)
    -- upvalues: v2 (ref)
    local v255 = type(...) == "table" and ... or {
        ...
    };
    for v256, _ in pairs(v255) do
        v255[v256] = v2.header(v255[v256]);
    end;
    return ui.sidebar(table.unpack(v255));
end;
MUI.create = function(...)
    -- upvalues: v2 (ref), v1 (ref), v0 (ref)
    local v258 = type(...) == "table" and ... or {
        ...
    };
    local v259 = "";
    for v260, _ in pairs(v258) do
        if v260 == 2 then
            v259 = v258[v260];
        end;
        v258[v260] = v2.header(v258[v260]);
    end;
    local v262 = table.concat({
        table.unpack(v258)
    });
    if not v1[v262] then
        v1[v262] = ui.create(table.unpack(v258));
        v0[v262] = v259;
    end;
    return ui.create(table.unpack(v258));
end;
MUI.elements = function(...)
    ...
    elseif ... == "default" then
        ...
        local v263 = type(...) == "table" and table.concat(...) or table.concat({
            ...
        });
        local v264 = nil;
        for v265, v266 in pairs(v1) do
            if string.find(v265, v263) then
                v264 = v266;
            end;
        end;
        if not v264 then
...
local v4 = {
    string = {
        replace_char = function(v1, v2, v3)
            return ("%s%s%s"):format(v1:sub(1, v2 - 1), v3, v1:sub(v2 + 1));
        end
    }
};
v0.string.metatable = getmetatable("").__index;
v0.string.trim = nil;
v0.string.metatable.trim = function(v5)
    return (v5:match("^%s*(.*)"):match("(.-)%s*$"));
end;
string.trim = function(v6)
    return (v6:trim());
end;
v0.string.trim = function(...)
    return string.trim(...);
end;
v0.string.first_upper = nil;
v0.string.metatable.first_upper = function(v7)
    local v8, _ = ("%s%s"):format(string.upper(v7:sub(1, 1)), v7:sub(2, #v7));
    return v8;
end;
string.first_upper = function(v10)
    return (v10:first_upper());
end;
v0.string.first_upper = function(...)
    return string.first_upper(...);
end;
v0.string.first_lower = nil;
v0.string.metatable.first_lower = function(v11)
    local v12, _ = ("%s%s"):format(string.lower(v11:sub(1, 1)), v11:sub(2, #v11));
    return v12;
end;
string.first_lower = function(v14)
    return (v14:first_lower());
end;
v0.string.first_lower = function(...)
    return string.first_lower(...);
end;
v0.string.cut = nil;
v0.string.metatable.cut = function(v15, v16)
    if not v16 then
        v16 = 1;
    end;
    return v16 > 0 and v15:sub(v16 + 1) or string.reverse(string.reverse(v15):sub(-v16 + 1));
end;
string.cut = function(v17, v18)
    if not v18 then
        v18 = 1;
    end;
    return (v17:cut(v18));
end;
v0.string.cut = function(...)
    return string.cut(...);
end;
v0.string.split = nil;
v0.string.metatable.split = function(v19, v20)
    local v21 = {};
    for v22 in string.gmatch(v19, "([^" .. v20 .. "]+)") do
        table.insert(v21, v22);
    end;
    return v21;
end;
string.split = function(v23, v24)
    if not v24 then
        v24 = "%s";
    end;
    return (v23:split(v24));
end;
v0.string.split = function(...)
    return string.split(...);
end;
v0.string.transform = nil;
v0.string.transform = function(v25, v26)
    -- upvalues: v4 (ref)
    local l_v25_0 = v25;
    for v28 = 1, math.max(#v25, #v26) do
        local v29 = {
            [1] = v25:sub(v28, v28), 
            [2] = v26:sub(v28, v28)
        };
        if v29[1] ~= v29[2] then
            l_v25_0 = v4.string.replace_char(l_v25_0, v28, v29[2]);
            break;
        end;
    end;
    return l_v25_0;
...
v0.number.round = nil;
math.round = function(v30)
    return (tonumber(("%.0f"):format(v30)));
end;
v0.number.round = function(...)
    return math.round(...);
end;
v0.number.fixed = nil;
math.fixed = function(v31, v32)
    if not v32 then
        v32 = 1;
    end;
    return (string.format("%." .. tonumber(v32) .. "f", v31));
end;
v0.number.fixed = function(...)
    return math.fixed(...);
end;
v0.table.find = nil;
table.find = function(v33, v34, v35)
    if not v34 then
        v34 = "not";
    end;
    for v36, v37 in pairs(v33) do
        if v35 and v37:lower() == v34.lower(v34) or v37 == v34 then
            return v36;
        end;
    end;
    return 0;
end;
v0.table.find = function(...)
    return table.find(...);
end;
pcall(function()
...
pcall(function()
    ffi.cdef("        #pragma pack(push)\n        #pragma pack(1)\n            struct WIN32_FIND_DATAA {\n                uint32_t dwFileAttributes;\n                uint64_t ftCreationTime;\n                uint64_t ftLastAccessTime;\n                uint64_t ftLastWriteTime;\n                struct {\n                    union {\n                        uint64_t packed;\n                        struct {\n                            uint32_t high;\n                            uint32_t low;\n                        };\n                    };\n                } nFileSize;\n                uint32_t dwReserved[2];\n                char cFileName[260];\n                char cAlternateFileName[14];\n            };\n        #pragma pack(pop)\n            void* FindFirstFileA(const char* pattern, struct WIN32_FIND_DATAA* fd);\n            bool FindNextFileA(void* ff, struct WIN32_FIND_DATAA* fd);\n            bool FindClose(void* ff);\n    ");
end);
v0.file_system.ffi = {
    WIN32_FIND_DATAA = ffi.typeof("struct WIN32_FIND_DATAA"), 
    INVALID_HANDLE = ffi.cast("void*", -1), 
    URLMON = ffi.load("UrlMon"), 
    WININET = ffi.load("WinInet")
};
v0.file_system.download_file = nil;
files.download_file = function(v38, v39, v40)
    -- upvalues: v0 (ref)
    local v41 = 400;
    local function v44(v42, v43)
        -- upvalues: v0 (ref), v41 (ref)
        v0.file_system.ffi.WININET.DeleteUrlCacheEntryA(v42);
        v0.file_system.ffi.URLMON.URLDownloadToFileA(nil, v42, v43, 0, 0);
        v41 = 200;
    end;
    pcall(function()
        -- upvalues: v40 (ref), v44 (ref), v38 (ref), v39 (ref), v41 (ref)
        if not v40 then
            v44(v38, v39);
        elseif type(v40) == "boolean" then
            v44(v38, v39);
            local v45 = files.read(v39);
            print_error(("\aFF2020['\aFFFFFF%s\aFF2020']: Replace the Boolean value with a Number: \aFFFFFF%s"):format(v39, #v45));
        else
            local v46 = files.read(v39);
            if v46 == nil or #v46 ~= v40 then
                v44(v38, v39);
            end;
        end;
        v41 = v41 == 200 and 200 or 208;
    end);
    return v41;
end;
v0.file_system.download_file = function(...)
    return files.download_file(...);
end;
v0.file_system.delete_file = nil;
files.delete_file = function(v47)
    local v48 = 400;
    pcall(function()
        -- upvalues: v47 (ref), v48 (ref)
        v48 = ffi.C.DeleteFileA(v47) and 200 or 404;
    end);
    return v48;
end;
v0.file_system.delete_file = function(...)
    return files.delete_file(...);
end;
v0.file_system.read_folder = nil;
files.read_folder = function(v49)
    -- upvalues: v0 (ref)
    local v50 = {};
    local v51 = ffi.new(v0.file_system.ffi.WIN32_FIND_DATAA);
    local v52 = ffi.C.FindFirstFileA(("%s\\*"):format(v49), v51);
    if v52 ~= v0.file_system.ffi.INVALID_HANDLE then
        repeat
            local v53 = ffi.string(v51.cFileName);
            if v53 ~= "" and v53 ~= " " and v53 ~= "." and v53 ~= ".." then
                table.insert(v50, v53);
            end;
        until not ffi.C.FindNextFileA(v52, v51);
        ffi.C.FindClose(ffi.gc(v52, nil));
    end;
    return v50;
end;
v0.file_system.read_folder = function(...)
    return files.read_folder(...);
end;
v0.file_system.delete_folder = nil;
files.delete_folder = function(v54)
    local v55 = 400;
    pcall(function()
        -- upvalues: v54 (ref), v55 (ref)
        v55 = ffi.C.RemoveDirectoryA(v54) and 200 or 404;
    end);
    return v55;
end;
v0.file_system.delete_folder = function(...)
    return files.delete_folder(...);
end;
v0.anti_aim.condition = {
    delay = 0, 
    air = 0.065, 
    priority = "G", 
    state = {
...
v0.rage_bot.logs = {
    ...
    utils = {
        find = function(v56)
            -- upvalues: v0 (ref)
            local v57 = 0;
            for v58 = 1, #v0.rage_bot.logs.object.list do
                local v59 = v0.rage_bot.logs.object.list[v58];
                if v59 and v59 == v56 then
                    v57 = v58;
                end;
            end;
            return v57;
...
v0.anti_aim.condition.update = nil;
v0.anti_aim.condition.configuration = function(v60)
    -- upvalues: v0 (ref)
    v0.anti_aim.condition.air = v60;
end;
v0.anti_aim.condition.update = function()
    -- upvalues: v0 (ref)
    local v61 = entity.get_local_player();
    if not v61 then
        v0.anti_aim.condition.priority = "G";
        v0.anti_aim.condition.delay = 0;
        return;
    else
        if bit.band(v61.m_fFlags, 1) == 1 then
            if v0.anti_aim.condition.delay == 0 then
                v0.anti_aim.condition.delay = globals.curtime;
            end;
            if globals.curtime - v0.anti_aim.condition.delay > v0.anti_aim.condition.air then
                v0.anti_aim.condition.state.air = false;
                v0.anti_aim.condition.delay = 0;
            end;
        else
            v0.anti_aim.condition.state.air = true;
            v0.anti_aim.condition.delay = 0;
        end;
        local v62 = math.floor(v61.m_vecVelocity:length()) - 1;
        if v62 < 0 then
            v62 = 0;
        end;
        v0.anti_aim.condition.state.standing = v62 <= 1;
        v0.anti_aim.condition.state.moving = v62 >= 2 and not v0.anti_aim.condition.state.air;
        v0.anti_aim.condition.state.slow_walk = ui.find("Aimbot", "Anti Aim", "Misc", "Slow Walk"):get() and not v0.anti_aim.condition.state.standing;
        v0.anti_aim.condition.state.crouch = v61.m_flDuckAmount > 0.75 or ui.find("Aimbot", "Anti Aim", "Misc", "Fake Duck"):get();
        v0.anti_aim.condition.state.air_crouch = v0.anti_aim.condition.state.air and v0.anti_aim.condition.state.crouch;
        if v0.anti_aim.condition.state.standing then
            v0.anti_aim.condition.priority = "S";
        end;
        if v0.anti_aim.condition.state.moving then
            v0.anti_aim.condition.priority = "M";
        end;
        if v0.anti_aim.condition.state.slow_walk then
            v0.anti_aim.condition.priority = "SW";
        end;
        if v0.anti_aim.condition.state.crouch then
            v0.anti_aim.condition.priority = "C";
        end;
        if v0.anti_aim.condition.state.air then
            v0.anti_aim.condition.priority = "A";
        end;
        if v0.anti_aim.condition.state.air_crouch then
            v0.anti_aim.condition.priority = "AC";
        end;
        return;
    end;
end;
v0.anti_aim.condition.get_state = function(v63)
    -- upvalues: v0 (ref)
    ...
    for v64, v65 in pairs(v0.anti_aim.condition.state) do
        if tostring(v64) == tostring(v63) then
            return v65;
        end;
    end;
    return v0.anti_aim.condition.state;
end;
v0.anti_aim.condition.get = function(v66)
    -- upvalues: v0 (ref)
    local v67 = "G";
    local v68 = {
        AC = false, 
    ...
    if not v66 then
        ...
        for _, v72 in pairs(v66) do
            if v68[v72:upper()] ~= nil then
                v68[v72:upper()] = true;
            end;
        end;
    end;
    local l_priority_0 = v0.anti_aim.condition.priority;
    if v68.S and l_priority_0 == "S" then
        v67 = "S";
    end;
    if v68.M and l_priority_0 == "M" then
        v67 = "M";
    end;
    if v68.SW and l_priority_0 == "SW" then
        v67 = "SW";
    end;
    if v68.C and l_priority_0 == "C" then
        v67 = "C";
    end;
    if v68.A and l_priority_0 == "A" then
        v67 = "A";
    end;
    if v68.AC and l_priority_0 == "AC" then
        v67 = "AC";
    end;
    return v67;
end;
v0.rage_bot.logs.get = nil;
v0.rage_bot.logs.get = function(_)
    -- upvalues: v0 (ref)
    return v0.rage_bot.logs.object.list;
end;
v0.rage_bot.logs.aim_ack = function(v75)
    -- upvalues: v0 (ref)
    local v76 = {
        prefix = v75.state and "miss" or "hit"
    };
    local v77 = {
        basic = {
            type = "aimbot", 
        ...
        info = {
            ...
            hitchance = v75.hitchance, 
            aim = v75.aim, 
            state = v75.state, 
            damage = {
                self = v75.damage or "?", 
                wanted = v75.wanted_damage or "?"
            }, 
            hitgroup = {
                wanted_name = "?", 
                self_name = "?", 
                self = v75.hitgroup or "?", 
                wanted = v75.wanted_hitgroup or "?"
            }
        }
    };
    v77.info.target.name = v77.info.target.self:get_name():gsub("\n", "");
    v77.info.target.health = v77.info.target.self.m_iHealth or 0;
    if v77.info.target.health < 0 then
        v77.info.target.health = 0;
    end;
    v77.info.backtrack.time = globals.tickinterval * v77.info.backtrack.self * 1000;
    v77.info.mismatch = v77.info.damage.self ~= v77.info.damage.wanted or v77.info.hitgroup.self ~= v77.info.hitgroup.wanted;
    if v77.info.hitgroup.self ~= "?" then
        v77.info.hitgroup.self_name = v0.rage_bot.logs.object.hitgroups[v77.info.hitgroup.self] or "?";
    end;
    if v77.info.hitgroup.wanted ~= "?" then
        v77.info.hitgroup.wanted_name = v0.rage_bot.logs.object.hitgroups[v77.info.hitgroup.wanted] or "?";
    end;
    v77.remove = function()
        -- upvalues: v0 (ref), v77 (ref)
        local v78 = v0.rage_bot.logs.utils.find(v77);
        if v78 == 0 then
            return;
        else
            table.remove(v0.rage_bot.logs.object.list, v78);
            return;
        end;
    end;
    table.insert(v0.rage_bot.logs.object.list, v77);
end;
v0.rage_bot.logs.player_hurt = function(v79)
    -- upvalues: v0 (ref)
    if entity.get_local_player() ~= entity.get(v79.attacker, true) then
        return;
    else
        local v80 = {
            weapon = v79.weapon, 
        ...
        if v80.weapon then
            if v80.weapon == "hegrenade" then
                v80.prefix = "nade";
            elseif v80.weapon == "inferno" then
                v80.prefix = "burn";
            elseif v80.weapon == "knife" then
                v80.prefix = "knife";
            elseif v80.weapon == "taser" then
                v80.prefix = "taser";
            end;
        end;
        if v80.prefix == "?" then
            ...
            local v81 = {
                ...
                info = {
                    ...
                    target = {
                        health = "?", 
                        name = "?", 
                        self = entity.get(v79.userid, true)
                    }, 
                    backtrack = {
                        self = "?", 
                        time = "?"
                    ...
                    damage = {
                        wanted = "?", 
                        self = v79.dmg_health or "?"
                    }, 
                    hitgroup = {
                        wanted = "?", 
                        wanted_name = "?", 
                        self_name = "?", 
                        self = v79.hitgroup or "?"
                    }
                }
            };
            v81.info.target.name = v81.info.target.self:get_name():gsub("\n", "");
            v81.info.target.health = v79.health or 0;
            if v81.info.target.health < 0 then
                v81.info.target.health = 0;
            end;
            v81.info.backtrack.time = "?";
            v81.info.mismatch = "?";
            if v81.info.hitgroup.self ~= "?" then
                v81.info.hitgroup.self_name = v0.rage_bot.logs.object.hitgroups[v81.info.hitgroup.self] or "?";
            end;
            v81.remove = function()
                -- upvalues: v0 (ref), v81 (ref)
                local v82 = v0.rage_bot.logs.utils.find(v81);
                if v82 == 0 then
                    return;
                else
                    table.remove(v0.rage_bot.logs.object.list, v82);
                    return;
                end;
            end;
            table.insert(v0.rage_bot.logs.object.list, v81);
            return;
        end;
    end;
end;
...
v0.new = function(v1, v2, v3)
    -- upvalues: v0 (ref)
    local v4 = v0.auxiliary.animation[v1];
    if not v4 then
        if not v2 then
            v2 = 5;
        end;
        v0.auxiliary.animation[v1] = {
            update = false, 
            multi = 0, 
            speed = v2, 
            auto = v3, 
            time = {
                currently = globals.realtime, 
                previous = globals.realtime
            }, 
            table = {
                storage = {}, 
                active = {}
        ...
        v4 = v0.auxiliary.animation[v1];
    end;
    if not v4.update then
        v0.update(v1, 5);
    end;
    v4.update = false;
end;
v0.update = function(v5, v6)
    -- upvalues: v0 (ref)
    local v7 = v0.auxiliary.animation[v5];
    v7.time.previous = v7.time.currently;
    v7.time.currently = globals.realtime;
    v7.speed = v6;
    v7.multi = (v7.time.currently - v7.time.previous) * v7.speed;
    for v8, _ in pairs(v7.table.storage) do
        if not v7.table.active[v8] then
            v7.table.storage[v8] = nil;
        end;
    end;
    v7.table.active = {};
    v7.update = true;
end;
v0.linear = function(v10, v11, v12, v13, v14)
    -- upvalues: v0 (ref)
    local v15 = v0.auxiliary.animation[v10];
    if not v15 then
        v0.new(v10, 5, v11);
        v15 = v0.auxiliary.animation[v10];
    end;
    if v15.auto == v11 then
        v0.new(v10);
        v0.update(v10, 5);
    end;
    if v12 == nil then
    ...
    if v17 == "color" then
        ...
        if not v14 then
            v14 = color(100, 100, 100, 100);
        end;
        local v18 = v15.table.storage[v11];
        local v19 = {};
        for _, v21 in pairs({
            [1] = "r", 
            [2] = "g", 
            ...
            v19[v21] = v15.multi * (v12 and 1 or -1) * (v14[v21] - v13[v21]);
        end;
        local v22 = color();
        for _, v24 in pairs({
            [1] = "r", 
            ...
            v22[v24] = math.clamp(v18 and v15.table.storage[v11][v24] or v13[v24], v13[v24], v14[v24]);
            v22[v24] = math.clamp(v22[v24] + v19[v24], v13[v24], v14[v24]);
        end;
        v15.table.storage[v11] = v22;
        v15.table.active[v11] = true;
        return v15.table.storage[v11];
    elseif v17 == "vector" then
        if not v13 then
            v13 = vector(0, 0, 0);
        end;
        if not v14 then
        ...
        local v25 = v15.table.storage[v11];
        local v26 = {};
        for _, v28 in pairs({
            [1] = "x", 
            [2] = "y", 
            ...
            v26[v28] = v15.multi * (v12 and 1 or -1) * (v14[v28] - v13[v28]);
        end;
        local v29 = vector();
        for _, v31 in pairs({
            [1] = "x", 
            ...
            v29[v31] = math.clamp(v25 and v15.table.storage[v11][v31] or v13[v31], v13[v31], v14[v31]);
            v29[v31] = math.clamp(v29[v31] + v26[v31], v13[v31], v14[v31]);
        end;
        v15.table.storage[v11] = v29;
        v15.table.active[v11] = true;
        return v15.table.storage[v11];
    elseif v17 == "number" then
        ...
        local v32 = v15.multi * (v12 and 1 or -1) * (v14 - v13);
        local v33 = math.clamp(v15.table.storage[v11] or v13, v13, v14);
        v33 = math.clamp(v33 + v32, v13, v14);
        v15.table.storage[v11] = v33;
        v15.table.active[v11] = true;
        return v15.table.storage[v11];
    else
        return v15.table.storage[v11];
...
v0.lerp = function(v34, v35, v36)
    if not v36 then
        v36 = 5;
    end;
    return v34 + (v35 - v34) * (globals.frametime * v36);
end;
v0.unclamped_lerp = function(v37, v38, v39)
    -- upvalues: v0 (ref)
    if not v39 then
        v39 = 5;
    end;
    return math.abs(v38 - v37) < 0.5 and v38 or v0.lerp(v37, v38, v39);
end;
return v0;
...
v0.register = function(v1, v2, v3, v4, v5, v6, v7)
    -- upvalues: v0 (ref)
    local v8 = {
        enable = true, 
        index = #v0.inventory + 1, 
        position = vector(v1:get(), v2:get()), 
        size = vector(v3, v4), 
        drag = vector(v6 or 0, v7 or 0, 0), 
        dragging = {
            active = false, 
            position = vector(0, 0)
        }, 
    ...
    table.insert(v0.inventory, v8);
    return setmetatable(v8, v0);
end;
v0.restrictions = function(v9)
    -- upvalues: v0 (ref)
    if v9.position.x <= 0 then
        v9.position.x = 0;
    end;
    if v9.position.x + v9.size.x >= v0.auxiliary.screen.x then
        v9.position.x = v0.auxiliary.screen.x - v9.size.x;
    end;
    if v9.position.y <= 0 then
        v9.position.y = 0;
    end;
    if v9.position.y + v9.size.y >= v0.auxiliary.screen.y then
        v9.position.y = v0.auxiliary.screen.y - v9.size.y;
    end;
end;
v0.location = function(v10, v11)
    if v11.x >= v10.position.x - v10.drag.x and v11.x <= v10.position.x + v10.size.x + v10.drag.x and v11.y >= v10.position.y - v10.drag.x and v11.y <= v10.position.y + v10.size.y + v10.drag.x then
        v10.drag.z = 0;
    end;
    if v11.x >= v10.position.x - v10.drag.y and v11.x <= v10.position.x + v10.size.x + v10.drag.y and v11.y >= v10.position.y - v10.drag.y and v11.y <= v10.position.y + v10.size.y + v10.drag.y then
        return true;
    else
        return false;
    end;
end;
v0.update = function(v12, v13, ...)
    -- upvalues: v0 (ref)
    if common.is_button_released(1) then
        v12.drag.z = 1;
    end;
    if ui.get_alpha() ~= 0 then
        local v14 = ui.get_mouse_position();
        local v15 = v12:location(v14);
        local v16 = common.is_button_down(1);
        if (v15 or v12.dragging.active) and v16 and (v0.active == "" or v0.active == v12.index) then
            v0.active = v12.index;
            if not v12.dragging.active then
                v12.dragging.active = true;
                v12.dragging.position = v14 - v12.position;
            else
                v12.position = v14 - v12.dragging.position;
                v12:restrictions();
                v12.reference.x:set(math.floor(v12.position.x));
                v12.reference.y:set(math.floor(v12.position.y));
            end;
        elseif not v16 then
            v0.active = "";
            v12.dragging.active = false;
            v12.dragging.position = vector();
        end;
    end;
    if not v13 then
        v12:render(...);
...
v0.render = function(v17, ...)
    v17:callback(...);
end;
v0.set_priority = function()
    -- upvalues: v0 (ref)
    for v18 = #v0.inventory, 1, -1 do
        local v19 = v0.inventory[v18];
        if v19.dragging.active then
            table.insert(v0.inventory, 1, v19);
            table.remove(v0.inventory, v18 + 1);
        end;
    end;
    for v20 = #v0.inventory, 1, -1 do
        local v21 = v0.inventory[v20];
        if v21.enable then
            v21:render();
        end;
    end;
    for v22 = 1, #v0.inventory do
        local v23 = v0.inventory[v22];
        if v23.enable then
            v23:update(true);
        end;
    end;
end;
v0.synchronize = function()
    -- upvalues: v0 (ref)
    for v24 = 1, #v0.inventory do
        local v25 = v0.inventory[v24];
        v25.position = vector(v25.reference.x:get(), v25.reference.y:get());
    end;
end;
v0.get_anti_shot = function()
    -- upvalues: v0 (ref)
    local v26 = true;
    for _, v28 in pairs(v0.inventory) do
        if v28.enable and v26 then
            if v28.drag.z ~= 1 then
                v26 = false;
            else
                v26 = true;
            end;
...
v0.unset_render = function()
    -- upvalues: v0 (ref)
    events.render:unset(v0.events_render);
end;
v0.__index = v0;
v0.events_render = function()
    -- upvalues: v0 (ref)
    if #v0.inventory > 0 then
        for _, v30 in pairs(v0.inventory) do
            if ui.get_alpha() > 0 and v30.drag.z == 0 and not v0.anti_shot then
                utils.console_exec("-attack");
                utils.console_exec("-attack2");
            end;
            v30.position.x = math.floor(v30.reference.x:get());
            v30.position.y = math.floor(v30.reference.y:get());
            v30:restrictions();
        end;
    end;
end;
events.render(v0.events_render);
return v0;

end)()
local l_monylinear_0 = (function()

return {
    LettersList = {}, 
    Breathe = function(_, v1, v2)
        if not v2 then
            v2 = 1;
        end;
        if not v1 then
        ...
        return (math.cos(globals.realtime * v2 + v1) + 1) / 2;
    end, 
    Text = function(_, v4, v5, v6)
        local v7 = 0;
        local v8 = #v4:gsub("[\128-\191]", "");
        local v9 = "";
        for v10 in v4:gmatch(".[\128-\191]*") do
            v7 = v7 + 1 + (v6 or 0);
            local v11 = v7 / v8;
            v9 = string.format("%s\a%s%s", v9, v5(v7, v8, v10, v11):to_hex(), v10);
        end;
        return v9;
    end, 
    Gradient = function(_, v13, v14)
        if not v13 then
            v13 = {
                color(255, 255, 255), 
                color(0, 0, 0)
        ...
        elseif v14 >= 1 then
            ...
            local v15 = 1 / (#v13 - 1);
            local v16 = math.floor(v14 / v15);
            return (v13[v16 + 1]:lerp(v13[v16 + 2], (v14 - v16 * v15) / v15));
        end;
    end, 
    Static = function(v17, v18, v19)
        if not v18 then
            v18 = "AN EXAMPLE OF A STATIC GRADIENT";
        end;
        return v17:Text(v18, function(v20, v21, _, _)
            -- upvalues: v17 (ref), v19 (ref)
            return v17:Gradient(v19, v20 / v21);
        end);
    end, 
    Animate = function(v24, v25, v26, v27, v28)
        if not v25 then
            v25 = "EXAMPLE OF AN ANIMATED GRADIENT";
        end;
        if not v27 then
            v27 = 3;
        end;
        return v24:Text(v25, function(_, _, _, v32)
            -- upvalues: v24 (ref), v26 (ref), v27 (ref)
            return v24:Gradient(v26, v24:Breathe(v32, -v27));
        end, v28);
    end, 
    Letters = function(v33, v34, v35, v36, v37, v38)
        if v33.LettersList[v34] == nil then
            v33.LettersList[v34] = {
                Revers = v37 < 0, 
                Number = v37 < 0 and string.len(v34) or 1
            };
        end;
        if not v34 then
            v34 = "EXAMPLE OF AN ANIMATED GRADIENT";
        end;
        if not v37 then
            v37 = 3;
        end;
        return v33:Text(v34, function(v39, v40, _, v42)
            -- upvalues: v38 (ref), v33 (ref), v34 (ref), v37 (ref), v35 (ref), v36 (ref)
            if v38 == nil or v38 == false then
                if v33.LettersList[v34].Revers then
                    v33.LettersList[v34].Number = v33.LettersList[v34].Number + v37 / 750;
                    if v37 > 0 and v33.LettersList[v34].Number > v40 + 1 or v33.LettersList[v34].Number < 1 then
                        v33.LettersList[v34].Revers = not v33.LettersList[v34].Revers;
                    end;
                else
                    v33.LettersList[v34].Number = v33.LettersList[v34].Number - v37 / 750;
                    if v37 > 0 and v33.LettersList[v34].Number < 1 or v33.LettersList[v34].Number > v40 + 1 then
                        v33.LettersList[v34].Revers = not v33.LettersList[v34].Revers;
                    end;
                end;
            else
                v33.LettersList[v34].Number = v33.LettersList[v34].Number + v37 / 750;
                if v37 > 0 and v33.LettersList[v34].Number > v40 + 2 or v33.LettersList[v34].Number < 1 then
                    v33.LettersList[v34].Number = v37 < 0 and string.len(v34) + 2 or 1;
                end;
            end;
            if v39 ~= math.floor(v33.LettersList[v34].Number) then
                return v35;
            else
                return v33:Gradient(v36, v33:Breathe(v42, -v37));
            end;
        end);
    end
};
...
if not pcall(function()
    ...
    v61.home = {
        ...
        discord = l_mui_0.button(v61.tabs.home.recommendations, ("!mt<1>!h<!s<Link Active>>!i<discord>!d%s!d"):format(v29.center("Discord", 10)), true, function()
            panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/T6TderHP9D");
        end), 
        ...
        config = l_mui_0.button(v61.tabs.home.recommendations, ("!mt<1>!h<!s<Link Active>>!i<link>!d%s!d"):format(v29.center("Website 1", 12)), true, function()
            panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://github.com/aspyr1g/neverpaste-luas");
        end), 
        version = l_mui_0.button(v61.tabs.home.recommendations, ("!mt<1>!h<!s<Link Active>>!i<cart-shopping>!d%s!d"):format(v29.center("Website 2", 10)), true, function()
